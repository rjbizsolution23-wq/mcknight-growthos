  ...
  <div class="card p-6 overflow-x-auto">
    <table class="w-full text-xs text-left">
      ...
      <tbody class="text-gray-300 divide-y divide-blue-900/30">
        ...
        <tr><td class="py-2 pr-4 font-mono text-blue-300">CF_DEPLOY_API_TOKEN</td><td class="py-2 pr-4">/api/cf/*</td><td class="py-2 pr-4">Deploy funnels to your own Cloudflare account (Workers edit permission)</td><td class="py-2 font-mono">Key Vault above (recommended)</td></tr>
        <tr><td class="py-2 pr-4 font-mono text-blue-300">CF_DEPLOY_ACCOUNT_ID</td><td class="py-2 pr-4">/api/cf/*</td><td class="py-2 pr-4">Target Cloudflare account</td><td class="py-2 font-mono">Key Vault above (recommended)</td></tr>
